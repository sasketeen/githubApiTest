...
---
⚠️ Особенность реализации: так как у GitHub API есть ограничение по количеству запросов за единицу времени для неавторазованных пользователей, то для минимизации ненужных запросов после выбора нужного фильтра и характера сортировки (по возрастаю/по убыванию) для их применения нужно нажать повторно на кнопку поиска и только после этого отобразятся отсортированные данные
